...
- `instructions/proxy` - Proxy server binary (root directory)
- `instructions/cdpcli` - CDP client tool for dumping websites (root directory)
- `instructions/chrome.sh` - Script to start Chrome with debugging enabled (root directory)
